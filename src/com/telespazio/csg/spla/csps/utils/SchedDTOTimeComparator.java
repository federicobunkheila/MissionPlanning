/**
*
* MODULE FILE NAME: SchedDTOTimeComparator.java
*
...
/**
 * The comparator between DTO by start times.
 *
 * @author bunkheila
 *
 */
public class SchedDTOTimeComparator implements Comparator<SchedDTO> {

	/**
	 * Compare DTO by start times.
	 *
	 * @param dto1
	 *            - the first DTO
	 * @param dto2
